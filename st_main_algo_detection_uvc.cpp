...
MI_U32 show_w_max = 3400, show_h_max = 1700;
MI_U32 show_w = 3400, show_h = 1700;
...
void detect_callback(std::vector<Box_t> results)
{
    ...
    if(num_valid >30 && dis <64)
    {
        ...
        std::cout<< "compare_y_min:"<<compare_x_min<<"  compare_y_max"<<compare_x_max<<std::endl;

        if (show_w > 1800) // show_w_min = 3400-25*64
        {
            
            show_w = show_w -  64;
            show_h = show_h -  32;
            std::cout<<"dadadadada-----"<< "show_w:"<<show_w<<"  show_h"<<show_h<<std::endl;
            current_x = MI_U32((compare_x_max + compare_x_min)/2);
            current_y = MI_U32((compare_y_max + compare_y_min)/2);
        }
        else
        {
    ...
    if (num_unvalid>30)
    {
        if (show_w < show_w_max)
        {
            ...
            current_x = (current_x > 3)?(current_x - 2): 0;
            current_y = (current_y > 2)?(current_y - 1) : 0;
        }
    ...
    show_w = (show_w < 1800) ? 1800:show_w;
    show_h = (show_h < 900) ? 900:show_h;
